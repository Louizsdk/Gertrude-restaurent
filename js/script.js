...
function ajout_PLAT() {
    for (var j = 0; j < contenu.carte.length; j++) {
        ...
        plat.innerHTML += "<div class='footer-plat'> <p class=price_plat>" + contenu.carte[j].price + "</p> <input type = 'button' value = 'Ajouter au panier' class = 'button' name = 'button'> </div>";
